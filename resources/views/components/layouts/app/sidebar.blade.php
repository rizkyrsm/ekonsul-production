        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    @canRole('KONSELOR')
                        <a href="{{ route('dashboard.toggle-status') }}"
                        class="inline-flex items-center px-4 py-2 rounded-full font-medium text-sm transition 
                            ...
                            <span class="h-2 w-2 rounded-full mr-2 
                                {{ Auth::user()->status === 'ACTIVE' ? 'bg-green-500' : 'bg-red-500' }}">
                            </span>
                            &nbsp; 
